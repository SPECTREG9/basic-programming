...
const homeWorkNewsThai = homeworkNews.results.filter(function(element, index) {
    return element.language === "thai" && element.source_id === "Thai Pbs News"
    
})

const homeWorkNewsMap = homeworkNews.results.map(function(element, index) {
    return ({
        title: element.title,
        link: element.link,
...
console.log(homeWorkNewsThai)
console.log(homeWorkNewsMap)
